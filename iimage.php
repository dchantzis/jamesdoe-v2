...
<body bgcolor="#000000">
	...
	<table width="399" height="" cellpadding="1" cellspacing="3" border="0" bordercolor="#000000" bgcolor="">
		...
		<form name="ilf" id="ilf" action="./code.php?type=8" method="post">
		<tr>
			...
			<td width="142" height="" align="left" valign="middle"><?php if ($_GET["err2"]==2) { echo "<span class='error'>enter name</span>"; }?></td></tr>
		</tr>
		<tr>
			...
			<td width="142" height="" align="left" valign="middle"><?php if ($_GET["err3"]==3) { echo "<span class='error'>enter url</span>"; }?></td></tr>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="142" height="" align="left" valign="middle"><?php if ($_GET["err4"]==4) { echo "<span class='error'>choose type</span>"; }?></td></tr>
		</tr>
		<tr>
