...
<body bgcolor="#000000">
	...
	<table width="399" height="" cellpadding="1" cellspacing="3" border="0" bordercolor="#000000" bgcolor="">
		<tr><td height="" align="center" valign="middle" colspan="3">&nbsp;</td></tr>
		...
		<tr>
			...
			<td width="112" height="" align="left" valign="middle"><input type="text" id="cheadline" name="cheadline" style="width:112px" maxlength="20" value="<?=$_SESSION["cheadline"]?>"></td>
		...
		<tr>
			...
			<td width="112" height="" align="left" valign="middle"><input type="text" id="cname" name="cname" style="width:112px" maxlength="80" value="<?=$_SESSION["cname"]?>"></td>
		...
		<tr>
			...
			<td width="112" height="" align="left" valign="middle"><input type="text" id="cemail" name="cemail" style="width:112px" maxlength="30" value="<?=$_SESSION["cemail"]?>"></td>
		...
		<tr>
			...
			<td width="112" height="" align="left" valign="middle"><input type="text" id="ccomments" name="ccomments" style="width:112px" maxlength="30" value="<?=$_SESSION["ccomments"]?>"></td>
			<td width="142" height="" align="left" valign="middle"><?php if($_GET["err5"]==5) { echo "<span class='error'>choose type</span>"; } ?></td>
		</tr>
		<tr>
			<td width="125" height="" align="right" valign="middle">&nbsp;</td>
			<td width="112" height="" align="left" valign="middle"><input name="submit" id="submit" type="submit" style="width:112px" value="delete"></td>
			<td width="142" height="" align="left" valign="middle">&nbsp;</td>
		</tr>
		<tr>
